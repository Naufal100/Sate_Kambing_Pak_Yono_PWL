...
<head>
    ...
    <title>Edit Pesanan - Warung Sate Pak Yono</title>
        ...
        <form method="POST" action="/pesanan/{{ $pesanan->id }}">
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    required
                >{{ old('alamat', $pesanan->alamat) }}</textarea>
            </div>
            ...
            <div class="input-group">
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option value="pending" @if(old('status', $pesanan->status) == 'pending') selected @endif>Pending</option>
                        <option value="diproses" @if(old('status', $pesanan->status) == 'diproses') selected @endif>Diproses</option>
                        <option value="selesai" @if(old('status', $pesanan->status) == 'selesai') selected @endif>Selesai</option>
                        <option value="dibatalkan" @if(old('status', $pesanan->status) == 'dibatalkan') selected @endif>Dibatalkan</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                >{{ old('catatan', $pesanan->catatan) }}</textarea>
            </div>
